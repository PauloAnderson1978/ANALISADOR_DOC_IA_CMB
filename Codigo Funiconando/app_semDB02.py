...
def reset_question_state():
    ...
    st.session_state.question_text = ""  # Novo estado para armazenar o texto da pergunta
...
def add_to_history(question, answer):
    """Adiciona uma nova entrada ao histórico, mantendo no máximo 6 itens"""
...
if 'vectorstore' not in st.session_state:
    ...
    st.session_state.question_text = ""  # Novo estado para o texto da pergunta
...
def main():
    ...
    if st.session_state.vectorstore:
        ...
        with st.form(key='question_form'):
            # Usamos um campo de texto normal em vez de text_area para evitar conflitos
            ...
            with st.spinner("🤖 Analisando pergunta..."):
                try:
                    ...
                    if result and 'result' in result:
                        ...
                        st.session_state.question_text = ""  # Limpa o texto da pergunta
